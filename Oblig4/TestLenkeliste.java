...
public class TestLenkeliste {
    ...
    static void testLegesystem() {
      System.out.println("\nTest Legesystem");
      Legesystem legesystem = new Legesystem();
      Lege lege = new Lege("Dr. Alban");
      Lege lege2 = new Lege("Dr. Jones");
      Legemiddel legemiddel = new LegemiddelC("Apotekvare", 34, 88);
      Legemiddel paracet = new LegemiddelA("Paracet", 22, 33, 44);
      Pasient pasient = new Pasient("Gerda", "010101");
      Resept resept = new BlaaResept(legemiddel, lege, pasient, 5);

      legesystem.leggTil(legemiddel);
      legesystem.leggTil(paracet);

      legesystem.leggTil(lege2);
      legesystem.leggTil(lege);


      legesystem.leggTil(pasient);

      legesystem.leggTil(resept);

      Iterator<Pasient> la = legesystem.pasienter.iterator();
      sjekk(true, la.hasNext(), "Pasienter har element");

      Iterator<Lege> lg = legesystem.leger.iterator();
      sjekk("Dr. Alban", lg.next().hentLegeNavn(), "Legeliste er sortert");


      System.out.println();

      System.out.println("\nTester legg til legemiddel");
    ...
    static void testIterator() {
      ...
      liste.leggTil("Hoppla");
      Iterator<String> it = liste.iterator();
      sjekk(true, it.hasNext(), "iterator hasNext med ett element");
      sjekk("Hoppla", it.next(), "Riktig verdi iterator");
      sjekk(false, it.hasNext(), "Ingen flere elementer");
      liste.leggTil("Tjo");
      it = liste.iterator();
      sjekk(true, it.hasNext(), "To elementer");
      sjekk("Hoppla", it.next(), "Riktig verdi iterator");
      sjekk(true, it.hasNext(), "Enda et element");
      sjekk("Tjo", it.next(), "Neste verdi iterator");
    }
